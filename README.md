...
2. Ou, se já tiver a correção, **faça um fork**
   - Crie uma branch (`git checkout -b fix/nome-do-ajuste`)
   - Commit suas mudanças (sugiro usar conventional commits para as mensagens dos commits)
